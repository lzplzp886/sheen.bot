// src/app/(normal)/academy/workshops/register/step6/page.tsx
...
export default function Step6() {
  ...
  const next = () => {
    ...
    router.push("/academy/workshops/register/step7");
  };
  const back = () => router.push("/academy/workshops/register/step5");
